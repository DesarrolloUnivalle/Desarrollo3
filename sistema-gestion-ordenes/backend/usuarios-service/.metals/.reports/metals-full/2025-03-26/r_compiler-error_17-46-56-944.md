...
class UserServiceTest {
    ...
    void testRegistrarUsuario_Exitoso() {
        ...
        when(passwordEncoder.e@@ncode(request.getPassword())).thenReturn("encodedPassword");
        when(roleRepository.findByNombre(eq("Admin"))).thenReturn(Optional.of(role));  // ✅ Asegurar que devuelve el rol
