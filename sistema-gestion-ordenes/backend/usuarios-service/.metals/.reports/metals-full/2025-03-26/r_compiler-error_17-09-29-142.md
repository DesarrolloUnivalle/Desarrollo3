...
public class UserService {
    ...
    public UserResponseDTO registrarUsuario(UserRequestDTO request) {
        ...
        System.out.println("Buscando rol: '" + requ@@est.getRol().getNombre() + "'");
        Role role = roleRepository.findByNombre(request.getRol().getNombre()).orElseThrow(() -> new IllegalArgumentException("Rol no encontrado: " + request.getRol().getNombre()));
