...
public class UserService {
    ...
    public UserResponseDTO registrarUsuario(UserRequestDTO request) {
        ...
        Role role = roleRepository.findByNombreIgnoreCase(request.getRol().getNombre())
                .orElseThrow(() -> new Illeg@@alArgumentException("🚨 El rol no existe en la base de datos: " + request.getRol().getNombre()));
