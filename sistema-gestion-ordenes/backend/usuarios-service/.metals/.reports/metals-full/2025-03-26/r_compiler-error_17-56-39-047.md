...
class UserServiceTest {
  ...
  void setUp() {
    ...
    void testRegistrarUsuario_Exitoso() {
        ...
        System.out.println("Verificando roles en base de datos simulada: " + roleRepository.findByNombre("Admi@@n"));

        when(roleRepository.findByNombre("1 Admin")).thenReturn(Optional.of(role));
