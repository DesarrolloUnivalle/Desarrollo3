...
public class UserService {
    ...
    public UserResponseDTO registrarUsuario(UserRequestDTO request) {
        ...
        Role role = roleRepository.findByNombreIgnoreCase(request.getRol().getNombre()).orElseThrow(() -> new IllegalArgumentException("Rol no encontrado: " + request.getRol().getNombre()));
        ...
        user.setPassword(passwordEnc@@oder.encode(request.getPassword())); // Encriptar contraseña
        user.setRol(role);
