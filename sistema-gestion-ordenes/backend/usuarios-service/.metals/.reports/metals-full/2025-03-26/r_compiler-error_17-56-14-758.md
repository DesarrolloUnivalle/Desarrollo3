...
class UserServiceTest {
  ...
  void setUp() {
    ...
    void testRegistrarUsuario_Exitoso() {
        ...
        System.out.println("Verificando roles en base de datos simulada: " + roleRepository.findByNombre("Admin"));

        when(roleRepository.find@@ByNombre("1 Admin")).thenReturn(Optional.of(adminRole));
