...
public class UserService {
    ...
    public UserResponseDTO registrarUsuario(UserRequestDTO request) {
        ...
        System.out.println("🔍 Buscando rol con nombre: [" + request.getRol().getNombre() + "]");
        Optional<Role> roleOptional = roleRepository.findByNombre(request.getRol().getNombre().trim());

        if (roleOptional.isEmpty()) {
            System.out.println("🚨 R@@ol NO encontrado en la BD.");
        } else {
            System.out.println("✅ Rol encontrado: " + roleOptional.get());
        }
