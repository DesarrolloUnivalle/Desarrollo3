...
class UserServiceTest {
    ...
    void setUp() {
        ...
        when(roleRepository.findByNombre(anyString())).thenReturn(Optional.of(adminRole));
...
scala.collection.Iterator$$anon$19.next(Iterator.scala:973)
	...
	dotty.tools.pc.PcRenameProvider.<init>(PcRenameProvider.scala:19)
	dotty.tools.pc.ScalaPresentationCompiler.prepareRename$$anonfun$1(ScalaPresentationCompiler.scala:402)
```
#### Short summary: 
