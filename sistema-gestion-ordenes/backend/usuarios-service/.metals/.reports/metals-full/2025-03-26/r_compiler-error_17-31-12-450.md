...
class UserServiceTest {
    ...
    void testRegistrarUsuario_Exitoso() {
        ...
        whe@@n(passwordEncoder.encode(request.getPassword())).thenReturn("encodedPassword");
        ...
        Optional<Role> foundRole = roleRepository.findByNombre(request.getRol().getNombre().trim());
